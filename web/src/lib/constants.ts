...
export const CONSOLE_BRANDS: ConsoleBrand[] = [
  {
    ...
    models: [
      ...
      { id: "yamaha-tf5",   brand: "Yamaha", brandId: "yamaha_tf",     series: "TF Series", model: "TF5",         maxChannels: 32,  mixBuses: 20, fileFormat: ".tff", supported: true,  writable: true  },
      { id: "yamaha-tf3",   brand: "Yamaha", brandId: "yamaha_tf",     series: "TF Series", model: "TF3",         maxChannels: 32,  mixBuses: 20, fileFormat: ".tff", supported: true,  writable: true  },
      { id: "yamaha-tf1",   brand: "Yamaha", brandId: "yamaha_tf",     series: "TF Series", model: "TF1",         maxChannels: 32,  mixBuses: 20, fileFormat: ".tff", supported: true,  writable: true  },
      { id: "yamaha-dm7",   brand: "Yamaha", brandId: "yamaha_dm7",    series: "DM Series", model: "DM7",         maxChannels: 144, mixBuses: 72, fileFormat: ".dm7f", supported: true,  writable: true  },
      { id: "yamaha-rivage-pm10", brand: "Yamaha", brandId: "yamaha_rivage", series: "RIVAGE", model: "RIVAGE PM10", maxChannels: 216, mixBuses: 72, fileFormat: ".rivagepm", supported: true, writable: true },
    ],
  },
  {
    name: "DiGiCo",
